...
def get_data():
    data = pd.read_csv("../secqrv3_ml/datasets/data.csv")
    val_size = 0.2
...
def load_model():
    return tf.keras.models.load_model("../secqrv3_ml/model.h5")
...
urls = ["https://www.google.com", "diaryofagameaddict.com", "titon.info"]
